       ...
       <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            ...
            <input name="sn" id="ip" style="display:none;"value=<?php echo $_SESSION['info']['sn']?>  class="pendek" type="text">
            <input name="id" id="ip" style="display:none;" value=<?php echo $_SESSION['info']['p_id']?> class="pendek"  type="text">
