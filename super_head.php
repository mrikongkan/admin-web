...
?>
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="super_home.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="super_id.php">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>ALL ID </span></a>
      </li>
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="super_reset_all_id.php">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Reset All ID</span></a>
      </li>
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="super_transaction.php">
          <i class="fas fa-fw fa-chart-area"></i>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="super_self_change_password.php">
